...
//teacher
const AdminTeacherList = React.lazy(
  () => import("../views/admin/teacher/AdminTeacherList"),
);
const AdminAddTeacher = React.lazy(
  () => import("../views/admin/teacher/AdminAddTeacher"),
);
const AdminUserList = React.lazy(() => import("../views/admin/AdminUserList"));
const AdminUpdateUser = React.lazy(
  () => import("../views/admin/AdminUpdateUser"),
);
...
const routes = [
  ...
  {
    path: "/admin/teacher/teacher-list",
    name: "Teacher List",
